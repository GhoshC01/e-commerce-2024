...
import { selectProduct,fetchAllProductAsync } from '../productListSlice';
                              ...
                              <div className="mt-4 flex justify-between">
                                ...
                                <div>
                                  <p className="text-sm font-medium text-gray-900">
                                    ₹ {Math.round(product.price * (1 - product.discountPercentage / 100) * 70)}
                                  </p>
                                  <p className="text-sm font-medium text-gray-400 line-through">₹ {Math.round(product.price * 70)}</p>
